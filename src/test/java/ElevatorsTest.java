...
/*
        ...
        The objective of this exercise is to write a program that will identify
        which elevator will be served once a request for an elevator is registered.

        Please note these rules: < or:
        - An elevator is requested by default from <b>top</b> floor. </br>
        - An elevator can be resting at a given floor, going up or going down. k/br»
        ...
        Example: in a building of 10 floors, an elevator at the 3rd floor and ascending can never go down
        before reaching the 10th floor. And vice versa.</br>
...
public class ElevatorsTest{
    ...
    public void the_closest_elevator_to_top_floor_should_arrive_first () {
        ...
        // "(elevator id1: (elevator current floor] "
    ...
    public void elevators_going_up_and_not_stopping_should_arrive_first_to_top_floor(){
        ...
        // building.move ("id3", "UP"); // request elevator "id3" to stop at level 7
        String idOfFirstAvailableElevator = building.requestElevator () ;
        assertEquals ("id1", idOfFirstAvailableElevator);
    }
    ...
    public void can_request_elevator_in_middle_of_building() {
            ...
            assertEquals("id2", idOfFirstAvailableElevator);
            //"id2" is the closest elevator to 5 th floor
    }
}